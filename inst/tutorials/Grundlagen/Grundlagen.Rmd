...
```{r ex-vector-1, exercise=TRUE, results = "hold", exercise.eval=FALSE, error=TRUE}
...
```{r ex-vector-2, exercise=TRUE, results = "hold", exercise.eval=FALSE, error=TRUE}
blumen <- c("Tulpen", "Rosen", "Hund", "Sonnenblumen", "Hund")
```
...
```{r ex-vectorisiert-1, exercise=TRUE, results = "hold", exercise.eval=FALSE, error=TRUE}
zahlen <- 1:100
```
...
```{r ex-vectorisiert-2, exercise=TRUE, results = "hold", exercise.eval=FALSE, error=TRUE}
zahlen <- 1:100
...
```{r ex-vectorisiert-3, exercise=TRUE, results = "hold", exercise.eval=FALSE, error=TRUE}
nummer_1 <- 1:100
nummer_2 <- 100:1
```
...
```{r ex-factor-1, exercise=TRUE, results = "hold", exercise.eval=FALSE, error=TRUE, exercise.lines = 7}
...
<div class="uebungen">
`r otter::colorize("Aufgabe:", "var(--blue)")`
*Erstelle eine Liste aus den drei Objekten und greife auf das zweite Objekt zu.*
...
```{r ex-ifelse-01, exercise=TRUE, results = "hold", exercise.eval=FALSE, error=TRUE}
tier <- c("Reptil")
...
```{r ex-for-01, exercise=TRUE, results = "hold", exercise.eval=FALSE, error=TRUE, exercise.lines = 6}
...
```{r ex-while-01, exercise=TRUE, results = "hold", exercise.eval=FALSE, error=TRUE, exercise.lines = 6}
tiere <- c("Hunde", "Katzen", "Vögel")
results <- character(3)
for (i in 1:length(tiere)) {
