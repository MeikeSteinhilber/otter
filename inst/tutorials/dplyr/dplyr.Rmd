 ...
 *XXX*.
```{r ex-piping, exercise=TRUE, results = "hold", exercise.eval=FALSE}
...
`r otter::colorize("Aufgabe:", "var(--blue)")`
 *XXX*.
```{r ex-select, exercise=TRUE, results = "hold", exercise.eval=FALSE}
...
`r otter::colorize("Aufgabe:", "var(--blue)")`
 *XXX*.
```{r ex-filter, exercise=TRUE, results = "hold", exercise.eval=FALSE}
...
`r otter::colorize("Aufgabe:", "var(--blue)")`
 *XXX*.
```{r ex-arrrange, exercise=TRUE, results = "hold", exercise.eval=FALSE}
...
`r otter::colorize("Aufgabe:", "var(--blue)")`
 *XXX*.
```{r ex-rename, exercise=TRUE, results = "hold", exercise.eval=FALSE}
...
`r otter::colorize("Aufgabe:", "var(--blue)")`
 *XXX*.
```{r ex-mutate, exercise=TRUE, results = "hold", exercise.eval=FALSE}
...
`r otter::colorize("Aufgabe:", "var(--blue)")`
 *XXX*.
```{r ex-summarize, exercise=TRUE, results = "hold", exercise.eval=FALSE}
...
`r otter::colorize("Aufgabe:", "var(--blue)")`
 *XXX*.
```{r ex-groupby, exercise=TRUE, results = "hold", exercise.eval=FALSE}
