...
`r otter::colorize("Aufgabe:", "var(--blue)")`
*Entferne alle Zeilen mit fehlenden Werten aus dem Datensatz und gebe den datensatz aus.*
...
grade_this({
  ...
  if (identical(.result, data_health <- data_health[complete.cases(data_health), ])) {
    pass("Great work!")
  }
  if (identical(.result, data_health <- na.omit(data_health)
                )) {
    pass("Great work!")
  }
  fail("Try again!")
