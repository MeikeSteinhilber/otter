...
```
```{r, ref.label=I('setup-base-df'), eval=TRUE, echo=TRUE, exercise.eval=FALSE, exercise.lines = 25}
...
Wie `geom_text()`, aber mit Rahmen um das Label – nützlich für deutlichere Hervorhebung.
...
base_size <- 12
wrap_plots(
plot + theme_bw(base_size = base_size) + labs(title = "theme_bw", subtitle = ""),
plot + theme_light(base_size = base_size) + labs(title = "theme_light", subtitle = ""),
plot + theme_classic(base_size = base_size) + labs(title = "theme_classic", subtitle = ""),
plot + theme_minimal(base_size = base_size) + labs(title = "theme_minimal", subtitle = ""),
plot + theme_dark(base_size = base_size) + labs(title = "theme_dark", subtitle = ""),
plot + theme_grey(base_size = base_size) + labs(title = "theme_grey", subtitle = "")
)
ggsave("inst/tutorials/dplyr/images/themes.png", width = 30, height = 15, units = "cm")
```

![Themes](images/themes.png){.absolute .images-shadow  width="35%"}
