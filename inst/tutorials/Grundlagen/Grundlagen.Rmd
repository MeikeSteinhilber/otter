...
# !=
# der nächste Tipp ist die finale Lösung!
```
...
<div class="tip">
  ...
  <div class="tip-content"> Think about how the `+` operator works in R.</div>
  <div class="tip-content"> Ensure your function takes two arguments, `a` and `b`.</div>
  <div class="tip-content"> Remember to return the result using the `return()` function.</div>
  <button class="prev-tip">zurück</button>
  <button class="next-tip">weiter</button>
</div>
...
```
```{r ex-functions-02-hint, results = "hold", exercise.eval=FALSE}
...
taschen_rechner() # Diese Zeile soll nicht verändert werden
```
```{r ex-functions-03-hint, results = "hold", exercise.eval=FALSE}
