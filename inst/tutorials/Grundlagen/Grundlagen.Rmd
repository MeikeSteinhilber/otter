...
---
<div class="assessibility"></div>
<div class="offcanvas"><div class="title">Einstellungen für Barrierefreiheit</div><div class="button-container"><button data-setting="contrast"><span>Kontrast</span></button><button data-setting="links"><span>Links hervorheben</span></button><button data-setting="spacing"><span>Schriftabstand</button><button data-setting="dyslexia"><span>Legasthenie&shy;freundlich</span></button><button data-setting="cursor"><span>Cursor</span></button><button data-setting="lineheight"><div>Zeilenhöhe</div><div class="indicators"><div data-num="1"></div><div data-num="2"></div><div data-num="3"></div></div></button><button data-setting="fontsize"><span>Schriftgröße</span></button></div>
</div>
<script>
$(document).ready(function() {
  ...
  $(".assessibility").on("click", function() {
  ...
  $(".offcanvas button").on("click", function() {
    ...
    if(numIndicators > 0) {
      var currentIndicator = $(".indicators > div.dark", this).length || 0;
      currentIndicator = numIndicators % (currentIndicator + 1);
      console.log(numIndicators, currentIndicator);
    }
  ...
  `<div class="logo">
  <img class="logo" src="images/corporate_logos_small.jpg" style="width:30.0%"/>
