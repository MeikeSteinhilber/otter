...
`r otter::colorize("Aufgabe:", "var(--blue)")`
*Wähle die aus der ersten Spalte die dritte Zeile aus.*
...
`r otter::colorize("Aufgabe:", "var(--blue)")`
*Schreibe eine Funktion, die zwei Vektoren multiplizieren.*
...
`r otter::colorize("Aufgabe:", "var(--blue)")`
*Schreibe diese For-loop ine eine while-Loop um. Nutze dazu den Code, der bereits angegeben ist.*
