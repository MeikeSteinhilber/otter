...
sticker("man/figures/otteR_pink.png",
        package = "",
        filename = "man/figures/logo_pink.png",
        # Schrift
        p_color = "#CA225E",
        p_size = 140,    #70
        p_family = "alfa",
        ...
        u_y = 0.10,
        # Rahmen
        h_color = "#CA225E", #"#FFFFFF", #"#cedbf0", #"#474f5c",
        h_fill =  "white", # "#cedbf0",        #"#cedbf0", "#b0a5a9",
        h_size = 2,
...
sticker("man/figures/otteR_white.png",
        package = "",
        ...
        u_y = 0.10,
        # Rahmen
        h_fill = "#CA225E", #"#FFFFFF", #"#cedbf0", #"#474f5c",
        h_color =  "#CA225E", # "#cedbf0",        #"#cedbf0", "#b0a5a9",
        h_size = 2,
        white_around_sticker = FALSE,
        dpi = 1200,
        #spotlight
